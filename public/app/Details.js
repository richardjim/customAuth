...
//             formData.append('id', this.campaignEdit.id);
...
//     this.details = JSON.parse($("#details").val());
//     console.log("first",this.campaigns )
...
//                     subdomain: this.campaign.include_subdomain,
//                     xtras: JSON.stringify(xtras),
//                 }
