...
<html lang="en" dir="ltr">
    <head>
        ...
        <base href="https://66socialproof.com/demo/">
        <meta charset="UTF-8">
        ...
        <link rel="alternate" href="https://66socialproof.com/demo/notification/1108" hreflang="x-default" />
        
                    <link href="https://66socialproof.com/demo/uploads/favicon/9c3e51b8336fffdf712f4c3d40b9f1fd.png" rel="shortcut icon" />
        
        <link href="https://66socialproof.com/demo/themes/altum/assets/css/bootstrap-dark.min.css?v=1700" id="css_theme_style" rel="stylesheet" media="screen,print">
                    <link href="https://66socialproof.com/demo/themes/altum/assets/css/custom.css?v=1700" rel="stylesheet" media="screen,print">
                    <link href="https://66socialproof.com/demo/themes/altum/assets/css/animate.min.css?v=1700" rel="stylesheet" media="screen,print">
...
<script> if(window.location !== window.parent.location){ window.top.location.href = "https:\/\/66socialproof.com\/demo\/"; } </script>
...
<div class="ac-wrapper">
    <a href="https://altumcode.com/" target="_blank" class="ac-altumcode-link">
        ...
        <span>66socialproof by AltumCode</span>
    </a>

    <div>
        <a href="https://altumcode.com/contact" target="_blank" class="ac-secondary">Any questions? ✉️</a>
        <a href="https://altumco.de/66socialproof-buy" class="ac-primary">Buy 66socialproof</a>
    </div>
</div>
...
<nav class="navbar navbar-main  navbar-expand-lg navbar-light bg-white">
    <div class="container">
        <a class="navbar-brand" href="https://66socialproof.com/demo/">
                            <img src="https://66socialproof.com/demo/uploads/logo/365a9619f7af70e14acf8538d0d8c5d8.png" class="img-fluid navbar-logo" alt="Website Logo" />
                    </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="main_navbar">
            <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="https://66socialproof.com/demo/dashboard"> Dashboard</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="https://66socialproof.com/demo/campaigns"><i class="fa fa-fw fa-sm fa-server mr-2"></i> Campaigns</a>
                            <div class="dropdown-divider"></div>

                                                            <a class="dropdown-item" href="https://66socialproof.com/demo/account"><i class="fa fa-fw fa-sm fa-wrench mr-2"></i> Account</a>
                                <a class="dropdown-item" href="https://66socialproof.com/demo/account-plan"><i class="fa fa-fw fa-sm fa-box-open mr-2"></i> Plan</a>

                                                                    <a class="dropdown-item" href="https://66socialproof.com/demo/account-payments"><i class="fa fa-fw fa-sm fa-dollar-sign mr-2"></i> Payments</a>

                                                                    
                                <a class="dropdown-item" href="https://66socialproof.com/demo/account-api"><i class="fa fa-fw fa-sm fa-code mr-2"></i> API</a>

                                                            
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="https://66socialproof.com/demo/logout"><i class="fa fa-fw fa-sm fa-sign-out-alt mr-2"></i> Logout</a>
                        </div>
                    </li>
    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb">
            <ol class="custom-breadcrumbs small">
                <li>
                    <a href="https://66socialproof.com/demo/campaigns">Campaigns</a><i class="fa fa-fw fa-angle-right"></i>
                </li>
                <li>
                    <a href="https://66socialproof.com/demo/campaign/393">Campaign</a><i class="fa fa-fw fa-angle-right"></i>
                </li>
                ...
                <div class="row">
                    <div class="col-auto text-truncate">
                        <div class="d-flex align-items-center text-muted">
                            <img src="https://external-content.duckduckgo.com/ip3/riyad.rf.gd.ico" class="img-fluid icon-favicon mr-1" />
                            <div class="d-inline-block text-truncate">riyad.rf.gd</div>
                        </div>
                    </div>

                    <div class="col">
                        <span class="text-muted">
                            <i class="fa fa-fw fa-user-plus fa-sm mr-1"></i> Request Collector                        </span>
                    </div>
                </div>
            </div>
                ...
                <div class="d-flex align-items-center">
                    <div class="custom-control custom-switch mr-3" data-toggle="tooltip" title="Change the status">
                        <input
                                ...
                                id="campaign_is_enabled_1108"
                                data-row-id="1108"
                                onchange="ajax_call_helper(event, 'notifications-ajax', 'is_enabled_toggle')"
                                                    >
                        <label class="custom-control-label clickable" for="campaign_is_enabled_1108"></label>
                    </div>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="https://66socialproof.com/demo/notification/1108" class="dropdown-item"><i class="fa fa-fw fa-sm fa-pencil-alt mr-2"></i> Edit</a>
                            <a href="https://66socialproof.com/demo/notification/1108/statistics" class="dropdown-item"><i class="fa fa-fw fa-sm fa-chart-bar mr-2"></i> Statistics</a>
                            <a href="#" data-toggle="modal" data-target="#notification_duplicate_modal" data-notification-id="1108" class="dropdown-item"><i class="fa fa-fw fa-sm fa-copy mr-2"></i> Duplicate</a>
                            <a href="#" data-toggle="modal" data-target="#notification_delete_modal" data-notification-id="1108" class="dropdown-item"><i class="fa fa-fw fa-sm fa-trash-alt mr-2"></i> Delete</a>
                        </div>
                    </div>
                </div>
            </div>
...
<ul class="mt-5 nav nav-custom">
            <li class="nav-item">
            <a href="https://66socialproof.com/demo/notification/1108/settings" class="nav-link active">
                <i class="fa fa-fw fa-sm fa-cogs mr-1"></i> Settings            </a>
        </li>
    
            <li class="nav-item">
            <a href="https://66socialproof.com/demo/notification/1108/statistics" class="nav-link ">
                <i class="fa fa-fw fa-sm fa-chart-bar mr-1"></i> Statistics            </a>
        </li>
    
        <li class="nav-item">
        <a href="https://66socialproof.com/demo/notification/1108/data" class="nav-link ">
...
<div class="mt-5 mb-3 d-flex flex-column flex-md-row justify-content-between align-items-md-center">
    ...
    <div id="notification_preview" class="notification-preview-request_collector">
        ...
        <div>
            <form class="altumcode-request-collector-form" id="altumcode-request-collector-form" name="" action="" method="POST" role="form">
                <div class="altumcode-request-collector-row">
                    <input type="text" class="" name="input" placeholder="Valid Phone Number" aria-label="Valid Phone Number" required="required" />
...
<div class="row">
    ...
    <div class="form-group">
        ...
        <input type="text" id="settings_title" name="title" class="form-control" value="John" maxlength="256" />
    </div>

    <div class="form-group">
        <label for="settings_description">Description Message</label>
        <input type="text" id="settings_description" name="description" class="form-control" value="Support Team" maxlength="512" />
    </div>

    <div class="form-group">
        <label for="settings_image">Image URL</label>
        <input type="url" id="settings_image" name="image" class="form-control" value="https://img.icons8.com/cotton/2x/online-support.png" maxlength="2048" />
    ...
    <div class="form-group">
        ...
        <input type="text" id="settings_content_title" name="content_title" class="form-control" value="Any questions?" maxlength="256" />
    </div>

    <div class="form-group">
        <label for="settings_content_description">Content Description</label>
        <input type="text" id="settings_content_description" name="content_description" class="form-control" value="Let us know and we will get back to you!" maxlength="512" />
    </div>

    <div class="form-group">
        <label for="settings_input_placeholder">Input Placeholder</label>
        <input type="text" id="settings_input_placeholder" name="input_placeholder" class="form-control" value="Valid Phone Number" maxlength="128" />
    </div>

    <div class="form-group">
        <label for="settings_button_text">Button Text</label>
        <input type="text" id="settings_button_text" name="button_text" class="form-control" value="Call me back ⚡️" maxlength="128" />
    </div>

    <div class="form-group">
        <div class="custom-control custom-switch">
            <input id="settings_show_agreement" name="show_agreement" type="checkbox" class="custom-control-input" >
            <label class="custom-control-label" for="settings_show_agreement">Show Agreement</label>
            <div><small class="form-text text-muted">Require the user to confirm his agreement by ticking a checkbox.</small></div>
        </div>
    </div>
    ...
    <div id="agreement">
        <div class="form-group">
            ...
            <input type="text" id="settings_agreement_text" name="agreement_text" class="form-control" value="I read & agree the Privacy Policy" maxlength="256" />
        </div>

        <div class="form-group">
            <label for="settings_agreement_url">Agreement URL</label>
            <input type="url" id="settings_agreement_url" name="agreement_url" class="form-control" value="" maxlength="2048" />
        </div>
    </div>

    <div class="form-group">
        <label for="settings_thank_you_url">Thank you URL</label>
        <input type="text" id="settings_thank_you_url" name="thank_you_url" class="form-control" value="" maxlength="2048" />
        <small class="form-text text-muted">The URL the user will be redirected to after submitting the form. Leave empty to disable the function.</small>
    </div>
...
<div class="custom-control custom-switch mr-3 mb-3 ">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" id="settings_content_title_color" name="content_title_color" class="form-control border-left-0" value="#000" required="required" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" id="settings_content_description_color" name="content_description_color" class="form-control border-left-0" value="#000" required="required" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" id="settings_button_background_color" name="button_background_color" class="form-control border-left-0" value="#000" required="required" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" id="settings_button_color" name="button_color" class="form-control border-left-0" value="#fff" required="required" />
        </div>
    </div>
    ...
    <select id="settings_font" class="form-control" name="font">
        ...
        <input
                ...
                name="data_send_is_enabled"
                    >
        <label class="custom-control-label clickable" for="data_send_is_enabled">Send caught data to external sources</label>
    </div>

    <div id="data_send" class="container-disabled">
        <div class="form-group">
            <label for="settings_data_send_webhook">Webhook</label>
            <input type="text" id="settings_data_send_webhook" name="data_send_webhook" class="form-control" value="" maxlength="2048" placeholder="Webhook URL" aria-label="Webhook URL" />
            <small class="form-text text-muted">Leave empty to disable this field.</small>
        </div>

        <div class="form-group">
            <label for="settings_data_send_email">Email</label>
            <input type="text" id="settings_data_send_email" name="data_send_email" class="form-control" value="" maxlength="320"  placeholder="Valid email address" aria-label="Valid email address" />
            <small class="form-text text-muted">Leave empty to disable this field.</small>
        </div>
    </div>
...
<script>
    ...
    $('#notification_duplicate_modal').on('show.bs.modal', event => {
        let id = $(event.relatedTarget).data('notification-id');

        $(event.currentTarget).find('input[name="notification_id"]').val(id);
    });
</script>
<script>
    document.querySelectorAll('[data-choose-theme-style]').forEach(theme => {
        theme.addEventListener('click', event => {
            ...
            switch(chosen_theme_style) {
                case 'dark':
                    css.setAttribute('href', "https:\/\/66socialproof.com\/demo\/themes\/altum\/assets\/css\/bootstrap-dark.min.css?v=1700");
                ...
                case 'light':
                    css.setAttribute('href', "https:\/\/66socialproof.com\/demo\/themes\/altum\/assets\/css\/bootstrap.min.css?v=1700");
