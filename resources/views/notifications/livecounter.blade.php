...
<html lang="en" dir="ltr">
    <head>
        ...
        <link rel="alternate" href="https://66socialproof.com/demo/notification/1105" hreflang="x-default" />
    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb">
            <ol class="custom-breadcrumbs small">
                ...
                <li>
                    <a href="https://66socialproof.com/demo/campaign/394">Campaign</a><i class="fa fa-fw fa-angle-right"></i>
                </li>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <span class="text-muted">
                            <i class="fa fa-fw fa-globe fa-sm mr-1"></i> Live Counter                        </span>
                    </div>
                </div>
            </div>
                ...
                <div class="d-flex align-items-center">
                    <div class="custom-control custom-switch mr-3" data-toggle="tooltip" title="Change the status">
                        <input
                                ...
                                id="campaign_is_enabled_1105"
                                data-row-id="1105"
                                onchange="ajax_call_helper(event, 'notifications-ajax', 'is_enabled_toggle')"
                                                    >
                        <label class="custom-control-label clickable" for="campaign_is_enabled_1105"></label>
                    </div>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="https://66socialproof.com/demo/notification/1105" class="dropdown-item"><i class="fa fa-fw fa-sm fa-pencil-alt mr-2"></i> Edit</a>
                            <a href="https://66socialproof.com/demo/notification/1105/statistics" class="dropdown-item"><i class="fa fa-fw fa-sm fa-chart-bar mr-2"></i> Statistics</a>
                            <a href="#" data-toggle="modal" data-target="#notification_duplicate_modal" data-notification-id="1105" class="dropdown-item"><i class="fa fa-fw fa-sm fa-copy mr-2"></i> Duplicate</a>
                            <a href="#" data-toggle="modal" data-target="#notification_delete_modal" data-notification-id="1105" class="dropdown-item"><i class="fa fa-fw fa-sm fa-trash-alt mr-2"></i> Delete</a>
                        </div>
                    </div>
                </div>
            </div>
...
<ul class="mt-5 nav nav-custom">
            <li class="nav-item">
            <a href="https://66socialproof.com/demo/notification/1105/settings" class="nav-link active">
                <i class="fa fa-fw fa-sm fa-cogs mr-1"></i> Settings            </a>
        </li>
    
            <li class="nav-item">
            <a href="https://66socialproof.com/demo/notification/1105/statistics" class="nav-link ">
...
<div class="mt-5 mb-3 d-flex flex-column flex-md-row justify-content-between align-items-md-center">
    ...
    <div id="notification_preview" class="notification-preview-live_counter">
    ...
    <div class="altumcode-live-counter-content">
        ...
        <div class="altumcode-live-counter-header">
            ...
            <div class="altumcode-live-counter-close">
                <button class="altumcode-close" style="color: #000;">×</button>
            </div>
        </div>
...
<div class="row">
    ...
    <div class="form-group">
        ...
        <input type="text" id="settings_description" name="description" class="form-control" value="Active visitors now." maxlength="512" />
    </div>

    <div class="form-group">
        <label for="settings_last_activity">Count data from last X minutes</label>
        <input type="number" id="settings_last_activity" name="last_activity" class="form-control" value="200" required="required" />
    </div>

    <div class="form-group">
        <label for="settings_url">Notification URL</label>
        <input type="url" id="settings_url" name="url" class="form-control" value="" maxlength="2048" />
...
<div id="triggers" class="container-disabled">
                ...
                <select class="form-control trigger-type-select" name="trigger_type[]">
                    <option value="exact" data-placeholder="Full URL ( ex: https://domain.com )" selected="selected">Exact match</option>
...
<div class="form-group">
    <label for="settings_display_minimum_activity">Minimum activity</label>
    <input type="number" min="0" id="settings_display_minimum_activity" name="display_minimum_activity" class="form-control" value="0" />
    <small class="form-text text-muted">Minimum data needed to display the notification.</small>
</div>
...
<div class="custom-control custom-switch mr-3 mb-3 ">
    ...
    <label class="custom-control-label clickable" for="display_branding">Display Branding</label>
        ...
        <div class="input-group">
            ...
            <input type="text" id="settings_number_color" name="number_color" class="form-control border-left-0" value="#fff" required="required" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" id="settings_number_background_color" name="number_background_color" class="form-control border-left-0" value="#000" required="required" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" id="settings_pulse_background_color" name="pulse_background_color" class="form-control border-left-0" value="#17bf21" required="required" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" id="settings_close_button_color" name="close_button_color" class="form-control border-left-0" value="#000" required="required" />
        </div>
    </div>
