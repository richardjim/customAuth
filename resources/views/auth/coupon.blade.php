    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col text-truncate">
                <h1 class="h2 text-truncate"><span class="underline"> {{ $notifications->name }}  </span></h1>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <span class="text-muted">
                            ...
                            <i class="fa fa-fw fa-info-circle fa-sm mr-1"></i>  {{ $notifications->select }}                      </span>
                    </div>
                </div>
            </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="/statistics" class="dropdown-item"><i class="fa fa-fw fa-sm fa-chart-bar mr-2"></i> Statistics</a>
                            <a href="#" data-toggle="modal" data-target="#notification_duplicate_modal" data-notification-id="1107" class="dropdown-item"><i class="fa fa-fw fa-sm fa-copy mr-2"></i> Duplicate</a>
                            <a href="#" data-toggle="modal" data-target="#notification_delete_modal" data-notification-id="1107" class="dropdown-item"><i class="fa fa-fw fa-sm fa-trash-alt mr-2"></i> Delete</a>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="container">
    ...
    <div   id="update_notification">
        @csrf
    <div class="col" v-if="notifications.select == 'Informational'">
            ...
            <input type="text" id="settings_name" name="name" v-model=notification.name class="form-control" value="My new notification" maxlength="256" required="required" />
        </div>
    
        <div class="form-group">
            <label for="settings_title">Title Message</label>
            <input type="text" id="settings_title" name="title"  v-model=notification.title class="form-control" value="Flash sale!" maxlength="256" />
        </div>
    
        <div class="form-group">
            <label for="settings_description">Description Message</label>
            <input type="text" id="settings_description" name="description" v-model=notification.description class="form-control" value="Limited sale until tonight, right now!" maxlength="512" />
        </div>
    
        <div class="form-group">
            <label for="settings_image">Image URL</label>
            <input type="url" id="settings_image" name="image" v-model=notification.image_URL class="form-control" value="https://img.icons8.com/dusk/2x/sale.png" maxlength="2048" />
        ...
        <div class="form-group">
            ...
            <input type="text" id="settings_image_alt" name="image_alt" v-model=notification.image_Alt class="form-control" value="" maxlength="100" />
        ...
        <div class="form-group">
            ...
            <input type="url" id="settings_url" name="url" v-model=notification.notification_URL class="form-control" value="" maxlength="2048" />
    ...
    <div class="form-group">
        ...
        <select id="settings_font" class="form-control" name="font">
            ...
            <option value="Comic Sans MS" >Comic Sans MS</option>
                ...
                <div class="mt-4">
                    <button @click="update_Notification" class="btn btn-lg btn-block btn-primary">Update</button>
    ...
    <div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
        <div class="mb-3 mb-lg-0">
            <a class="h5" href="demo/">
                                    <img src="demo/uploads/logo/365a9619f7af70e14acf8538d0d8c5d8.png" class="mb-2 footer-logo" alt="Website Logo" />
                            </a>
    ...
    <div class="row">
        <div class="col-12 col-lg mb-3">
            <ul class="list-style-none d-flex flex-column flex-lg-row flex-wrap m-0">
                                                            ...
                                                            <li class="mb-2 mr-lg-3"><a href="/demo/page/terms-of-service" target="_self">Terms of Service</a></li>
                                            <li class="mb-2 mr-lg-3"><a href="/demo/page/create-campaign" target="_self">How to create a campaign</a></li>
                                            <li class="mb-2 mr-lg-3"><a href="/demo/page/create-notification" target="_self">How to create a notification</a></li>
                                            <li class="mb-2 mr-lg-3"><a href="/demo/page/install-script" target="_self">How to install the script</a></li>
                                                </ul>
        </div>
