    ...
    <main id="app">
                                ...
                                <td class="text-nowrap">
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="campaign/1">SocialProof</a>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="campaign/1" class="dropdown-item"><i
                                                        class="fa fa-fw fa-sm fa-server mr-1"></i>
                                                    View</a>
                                                <a href="campaign/1/statistics"
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-auto">
                        <div class="d-flex flex-wrap">
                            <a href="https://youtube.com" class="mr-2 mr-lg-0 ml-lg-2 mb-2" target="_blank"
                                data-toggle="tooltip" title="YouTube"><i class="fab fa-youtube fa-fw fa-lg"></i></a>
                            <a href="https://facebook.com" class="mr-2 mr-lg-0 ml-lg-2 mb-2" target="_blank"
                                data-toggle="tooltip" title="Facebook"><i class="fab fa-facebook fa-fw fa-lg"></i></a>
                            <a href="https://twitter.com" class="mr-2 mr-lg-0 ml-lg-2 mb-2" target="_blank"
                                data-toggle="tooltip" title="Twitter"><i class="fab fa-twitter fa-fw fa-lg"></i></a>
                            <a href="https://instagram.com" class="mr-2 mr-lg-0 ml-lg-2 mb-2" target="_blank"
                        ...
                        {{-- method="POST"  action="{{ route('store') }}" --}}
                         {{-- <form>  --}}
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">The domain name of the website where the campaign
                                    is
                                    going to run.</small>
                                <small class="form-text text-muted">Notifications will NOT work on other domains other
                                    than
                            ...
                            <div class="custom-control custom-switch">
                                ...
                                <label class="custom-control-label clickable" for="include_subdomains">Include
                                    Subdomains</label>
                                <small class="form-text text-muted">All the subdomains will match on this campaign as
                                    well
                                    if checked.</small>
                            </div>

                            <div class="text-center mt-4">
                                <button  type="button" class="btn btn-block btn-primary" @click="createCampaign">Create</button>
                            </div>
        ...
        <div class="modal fade" id="update_campaign" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <input type="hidden" name="campaign_id" value="" /> --}}
                        ...
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input"
                                v-model="campaignEdit.include_subdomain" id="campaign_update_include_subdomains">
                            <label class="custom-control-label clickable"
