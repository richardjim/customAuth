...
<section  class="container">
    ...
    <div class="mt-5 d-flex justify-content-between">
        ...
        <div class="col-auto p-0 d-flex">
            <div>
                                    <button type="button" data-toggle="modal" data-target="#create_campaign" class="btn btn-primary"><i class="fa fa-fw fa-sm fa-plus"></i> Create Campaign</button>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="tab-content">
                    <p class="text-muted">Copy and paste the following JS Code Snippet before the end of the <code></head></code> of your website.</p>
