...
<html lang="en" dir="ltr">
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
                    ...
                    <meta name="description" content="missing_translation: indexmeta_description" />
                            <meta name="keywords" content="missing_translation: indexmeta_keywords" />
        ...
        <link rel="stylesheet" href="https://socialproofo.com/demo/themes/altum/assets/css/aos.min.css">
<link href="https://socialproofo.com/demo/themes/altum/assets/css/pixel.css" rel="stylesheet" media="screen,print">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="main_navbar">
            <ul class="navbar-nav">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="{{ route ('login')}}"<i class="fa fa-fw fa-sm fa-sign-in-alt"></i> Login</a></li>

                                        <li class="nav-item active"><a class="nav-link" href="{{ route ('register')}}"><i class="fa fa-fw fa-sm fa-plus"></i> Register</a></li>
        ...
        <div class="index-cover">
            <div class="row mb-3">
                <div class="col-4">
                    ...
                    <div role="dialog" class="altumcode-wrapper altumcode-wrapper-rounded altumcode-wrapper-shadow altumcode-informational-wrapper" style='background-color: #fff;border-width: 0px;border-color: #000;;'>
        ...
        <div>
            ...
            <p class="altumcode-informational-description" style="color: #000">Limited sale until tonight, right now!</p>
                ...
                <div class="col-4">
                    ...
                    <div role="dialog" class="altumcode-wrapper altumcode-wrapper-rounded altumcode-wrapper-shadow altumcode-latest-conversion-wrapper" style='background-color: #fff;border-width: 0px;border-color: #000;;'>
    <div class="altumcode-latest-conversion-content">
                            <img src="https://img.icons8.com/dusk/2x/small-smile.png" class="altumcode-latest-conversion-image" alt="" loading="lazy" />
        ...
        <div>
            ...
            <div class="altumcode-latest-conversion-footer">
                ...
                <div class="col-4">
                    ...
                    <div role="dialog" class="altumcode-wrapper altumcode-wrapper-rounded altumcode-wrapper-shadow altumcode-random-review-wrapper" style='background-color: #fff;border-width: 0px;border-color: #000;;'>
    <div class="altumcode-random-review-content">
                <img src="https://img.icons8.com/color/2x/person-male.png" class="altumcode-random-review-image" alt="" loading="lazy" />
        ...
        <div>
            ...
            <div class="row mb-3">
                <div class="col-4">
                    ...
                    <div role="dialog" class="altumcode-wrapper altumcode-wrapper-rounded altumcode-wrapper-shadow altumcode-email-collector-wrapper" style='background-color: #fff;border-width: 0px;border-color: #000;;'>
            ...
            <div class="altumcode-email-collector-row">
                ...
                <div class="col-4">
                    <div>
                        ...
                        <div role="dialog" class="altumcode-wrapper altumcode-wrapper-rounded altumcode-wrapper-shadow altumcode-score-feedback-wrapper" style='background-color: #fff;border-width: 0px;border-color: #000;;'>
    <div class="altumcode-score-feedback-content">
        ...
        <p class="altumcode-score-feedback-description" style="color: #000">Rate from 1 to 5. 5 being excellent.</p>
                    ...
                    <div class="mt-3">
                        ...
                        <div role="dialog" class="altumcode-wrapper altumcode-wrapper-rounded altumcode-wrapper-shadow altumcode-conversions-counter-wrapper" style='background-color: #fff;border-width: 0px;border-color: #000;;'>
            ...
            <div class="altumcode-conversions-counter-close">
                ...
                <div class="col-4">
                    <div>
                        ...
                        <div role="dialog" class="altumcode-wrapper altumcode-wrapper-rounded altumcode-wrapper-shadow altumcode-emoji-feedback-wrapper" style='background-color: #fff;border-width: 0px;border-color: #000;;'>
    <div class="altumcode-emoji-feedback-content">
        ...
        <div class="altumcode-emoji-feedback-emojis">
                    ...
                    <div class="mt-3">
                        ...
                        <div role="dialog" class="altumcode-wrapper altumcode-wrapper-rounded altumcode-wrapper-shadow altumcode-cookie-notification-wrapper" style='background-color: #fff;border-width: 0px;border-color: #000;;'>
        ...
        <button type="button" class="altumcode-cookie-notification-button" style="background: #000;color: #fff">Okay</button>
            ...
            <div class="row mb-3">
                <div class="col-4">
                    ...
                    <div role="dialog" class="altumcode-wrapper altumcode-wrapper-rounded altumcode-wrapper-shadow altumcode-social-share-wrapper" style='background-color: #fff;border-width: 0px;border-color: #000;;'>
    <div class="altumcode-social-share-content">
        ...
        <p class="altumcode-social-share-description" style="color: #000">We appreciate all the shares to support us! Thank you!</p>
                ...
                <div class="col-4">
                    ...
                    <div role="dialog" class="altumcode-wrapper altumcode-wrapper-rounded altumcode-wrapper-shadow altumcode-request-collector-wrapper" style='background-color: #fff;border-width: 0px;border-color: #000;;'>
        ...
        <div>
            <div class="altumcode-request-collector-form" id="altumcode-request-collector-form" name="" action="" method="POST" role="form">
                ...
                <div class="col-4">
                    ...
                    <div role="dialog" class="altumcode-wrapper altumcode-wrapper-rounded altumcode-wrapper-shadow altumcode-live-counter-wrapper" style='background-color: #fff;border-width: 0px;border-color: #000;;'>
...
<div class="py-5 bg-gray-100 mt-10">
    <div class="container">
        <div class="text-center">
            <h2>626,370 notifications displayed</h2>
...
<div class="container mt-8">
    ...
    <div class="altumcode-informational-content">
        ...
        <div>
            ...
            <label class="col-12 col-md-6 col-lg-4 mb-3 mb-md-4 custom-radio-box mb-3">
                ...
                <div class="preview" style="display: none">
                    <div role="dialog" class="altumcode-wrapper altumcode-wrapper-rounded altumcode-wrapper-shadow altumcode-coupon-wrapper" style='background-color: #fff;border-width: 0px;border-color: #000;;'>
    ...
    <div class="altumcode-conversions-counter-content">
        ...
        <div class="altumcode-conversions-counter-header">
            ...
            <label class="col-12 col-md-6 col-lg-4 mb-3 mb-md-4 custom-radio-box mb-3">
                ...
                <div class="preview" style="display: none">
                    <div role="dialog" class="altumcode-wrapper altumcode-wrapper-rounded altumcode-wrapper-shadow altumcode-video-wrapper" style='background-color: #fff;border-width: 0px;border-color: #000;;'>
    ...
    <div class="altumcode-request-collector-content">
        ...
        <div>
            ...
            <label class="col-12 col-md-6 col-lg-4 mb-3 mb-md-4 custom-radio-box mb-3">
                ...
                <div class="preview" style="display: none">
                    <div role="dialog" class="altumcode-wrapper altumcode-wrapper-rounded altumcode-wrapper-shadow altumcode-countdown-collector-wrapper" style='background-color: #fff;border-width: 0px;border-color: #000;;'>
    <div class="altumcode-countdown-collector-content">
        ...
        <div class="altumcode-countdown-collector-timer">
            <input type="hidden" name="end_date" value="1644850617" />
...
<ul class="pricing-feature-list">
    <li class="pricing-feature">
        <strong>Unlimited</strong> Campaigns    </li>

    <li class="pricing-feature">
        <strong>25</strong> Notifications    </li>

    <li class="pricing-feature">
        <strong>50,000</strong> Notifications Impressions / month    </li>

    <li class="pricing-feature">
        <strong>30</strong> days statistics retention    </li>
                        ...
                        <li class="pricing-feature">No Ads</li>
                                ...
                                <li class="pricing-feature"><s>API access</s></li>
            </ul>
            ...
            >
                <div class="pricing-deco" style="">
                    ...
                    <div class="pricing-price">
                        <span class="d-none" data-plan-payment-frequency="monthly">4.99</span>
                        <span class="d-none" data-plan-payment-frequency="annual">49</span>
...
<ul class="pricing-feature-list">
    <li class="pricing-feature">
        <strong>25</strong> Campaigns    </li>

    <li class="pricing-feature">
        <strong>100</strong> Notifications    </li>

    <li class="pricing-feature">
        <strong>Unlimited</strong> Notifications Impressions / month    </li>

    <li class="pricing-feature">
        <strong>Unlimited</strong> days statistics retention    </li>
            ...
            >
                <div class="pricing-deco" style="">
                    ...
                    <div class="pricing-price">
                        <span class="d-none" data-plan-payment-frequency="monthly">6.99</span>
                        <span class="d-none" data-plan-payment-frequency="annual">49.9</span>
                        <span class="d-none" data-plan-payment-frequency="lifetime">499</span>
                        <span class="pricing-currency">USD</span>
                    </div>
...
<ul class="pricing-feature-list">
    ...
    <li class="pricing-feature">
        <strong>Unlimited</strong> Notifications    </li>

    <li class="pricing-feature">
        <strong>Unlimited</strong> Notifications Impressions / month    </li>

    <li class="pricing-feature">
        <strong>90</strong> days statistics retention    </li>
                ...
                <a href="/demo/register?redirect=pay/2" class="pricing-action">
                                                                        Choose plan                                                            </a>
            </div>
...
<div class="index-register-container mt-9">
    <div class="container">
        <div class="d-flex flex-row justify-content-around">
            ...
            <div>
                <a href="{{ route ('register')}}" class="btn btn-outline-light index-button">Get started</a>
            </div>
        </div>
    </div>
</div>
