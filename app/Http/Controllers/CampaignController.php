...
public function update(Request $request){
    ...
    try{
        ...
        // $campaign->name = $request->name;
        // $campaign->domain = $request->domain;
        // $campaign->include_subdomain = $request->include_subdomain;
        // $campaign->increment = $request->increment;
...
//         $campaign->increment= $request->increment ? $request->increment : $campaign->increment;
//         $campaign->campaign_id= $request->increment ? $request->increment : $campaign->increment;
//         $campaign->save();
//         return response()->json(["message" => "Updated Successfully!"], 200);
       
//     } catch (Exception $error) {
//         Log::info('Controller@update error message: ' . $error->getMessage());
